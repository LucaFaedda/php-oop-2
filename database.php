<?php
    ...
    $nobby = new Giocattolo('Nobby','3.71 Euro', '<i class="fa-solid fa-dog"></i> Cane','https://m.media-amazon.com/images/I/31MgbJi75aL._AC_SX450_.jpg','Pollo in lattice per far divertire il tuo cane','Large 47 cm');
